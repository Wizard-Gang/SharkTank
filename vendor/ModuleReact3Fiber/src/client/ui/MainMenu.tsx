...
import { getBackend, switchBackend } from "../net/backend.js";
...
export function MainMenu({
  ...
  return (
    <div className="center-screen">
      <div className="stack" style={{ width: "min(420px, 100%)", textAlign: "center" }}>
        <h1 style={{ margin: 0, fontSize: "2.6rem", letterSpacing: -1 }}>Snake Arena</h1>
